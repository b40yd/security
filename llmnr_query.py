...
class LLMNR_Query:
    ...
    def populate(self):
        ...
        self.lqs.bind(('', self.PORT))
        self.lqs.setblocking(False)
    ...
    def Query(self):
        ...
        while(True):
            ...
            #print(self.data)
            try:
                data, addr = self.lqs.recvfrom(4096)
                ...
                print("FROM: ", addr)
                print("DATA: ", data)
                #self._parse_multicast_recv_data_to_address(addr, data, addr_list)
            
        self.lqs.close()

if __name__ == "__main__":
    llmnr = LLMNR_Query(b"177.6.168.192.in-addr.arpa")
    llmnr.Query()
